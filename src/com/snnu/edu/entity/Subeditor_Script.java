...
public class Subeditor_Script {
	...
	public Subeditor_Script(int id, String suggestionc, String suggestione,
	...
	public Subeditor_Script() {
		super();
	}
	@Override
	public String toString() {
		return "Subeditor_Script [id=" + id + ", suggestionc=" + suggestionc
				+ ", suggestione=" + suggestione + ", checktimec=" + checktimec
